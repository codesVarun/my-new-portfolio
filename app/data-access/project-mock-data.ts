...
export const projectMockData: Project[] = [
  {
    projectId: "Project09",
    projectName: "Streaming Kafka Spark",
    projectDescription:
      "A real-time data streaming project where synthetic IoT data is generated by a producer, ingested via Kafka, processed using Spark Structured Streaming, and stored in PostgreSQL. A Streamlit dashboard is used for visualization. The entire architecture is containerized using Docker and Docker Compose.",
    projectRepoLink:
      "https://github.com/codesVarun/data-engineering-journey/tree/main/projects/streaming-kafka-spark",
