  ...
  return (
    <section className="flex flex-col justify-center px-6 py-12">
      ...
      <p className="text-xl max-w-xl leading-relaxed text-muted-foreground">
        I&rsquo;m a passionate <strong>Data Engineer</strong> and <strong>Full Stack Developer</strong> building robust backend systems and elegant frontend experiences.
      </p>
    </section>
  );
}
